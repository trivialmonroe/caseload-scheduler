...
const slotLog = [
  { studentId: 'a', week: 'Week 1', day: 'Mon', start: '9:00 AM', end: '9:30 AM' },
  { studentId: 'a', week: 'Week 5', day: 'Mon', start: '9:00 AM', end: '9:30 AM' },
  { studentId: 'b', week: 'Every Week', day: 'Tue', start: '10:00 AM', end: '10:30 AM' }
];
assert(
  'findLogIndexForCalendarSlot picks Week 5 not Week 1',
  eng.findLogIndexForCalendarSlot(slotLog, 'Mon', eng.timeStrToMinutes('9:00 AM'), 'a', 'Week 5') === 1
);
assert(
  'findLogIndexForCalendarSlot picks Week 1 for week 1 grid',
  eng.findLogIndexForCalendarSlot(slotLog, 'Mon', eng.timeStrToMinutes('9:00 AM'), 'a', 'Week 1') === 0
);
assert(
  'Every Week row matches any specific week grid',
  eng.findLogIndexForCalendarSlot(slotLog, 'Tue', eng.timeStrToMinutes('10:00 AM'), 'b', 'Week 7') === 2
);
assert(
  'logRowMatchesWeek rejects wrong quarter week',
  !eng.logRowMatchesWeek(slotLog[0], 'Week 5')
);
