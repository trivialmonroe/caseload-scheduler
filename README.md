...
- **Settings → Prefer Consistent Weekly Pattern** (default Yes) makes Quarterly students settle into a repeating 2-week A/B rotation — once a student lands on, say, Tuesday 9am in Week 1, every later Week 1/3/5/7/9 visit reuses that slot, and Week 2/4/6/8 visits reuse whatever slot was established in Week 2, so the routine is predictable for the provider, teachers, and the student rather than drifting week to week.
