...
- On the **week calendar**, drag a session onto a green cell to move the whole group, or onto an amber-outlined session to **swap** places when the week is full. Click a block to lock / edit members or pick a move/swap. Coverage is a report tab. Live minutes recheck after every edit.
