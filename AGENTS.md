...
- On the **week calendar**, drag a session onto a green cell to move the whole group (live schedule editor). Click a block to lock / edit members. Coverage is a report tab. Only valid times highlight. Live minutes recheck after every edit.
